...
export default function Services_NewsTap({ data, onChange }: any) {
  const {
    register,
    handleSubmit,
    watch,
  ...
  const isFormEmpty =
    ...
    !watchedValues.priceCountry;

  const onSubmit = async (formValues: FormData) => {
    try {
      const response = await axios.post(`${url}News/add-news`, formValues, {
        headers: {
